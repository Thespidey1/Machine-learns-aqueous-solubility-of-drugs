...
This repository contains the code and data. The codes for descriptor generation, hyperparameter optimization, model training, and model testing are included for both regression and classification tasks of solubility prediction. Four base learners (RF, XGB, LightGBM, and SVM) as well as their Stackings, and two advanced DL models (Transfoprmer-CNN and GNN) are presented.
