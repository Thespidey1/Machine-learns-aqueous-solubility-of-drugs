...
plt.savefig('./Lightgbm_ROC_curve_SC_1.png', dpi=1500)
plt.savefig('./Lightgbm_ROC_curve_SC_1.pdf', dpi=1500)
...
plt.savefig('./Lightgbm_ROC_curve_SC_2.png', dpi=1500)
plt.savefig('./Lightgbm_ROC_curve_SC_2.pdf', dpi=1500)
...
plt.savefig('./Lightgbm_ROC_curve_DrugBank.png', dpi=1500)
plt.savefig('./Lightgbm_ROC_curve_DrugBank.pdf', dpi=1500)
...
plt.savefig('./Lightgbm_ROC_curve.png', dpi=1500)
plt.savefig('./Lightgbm_ROC_curve.pdf', dpi=1500)
