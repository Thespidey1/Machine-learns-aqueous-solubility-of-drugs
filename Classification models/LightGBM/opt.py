...
def model_adjust_parameters(cv_params, other_params):
    ...
    model = lightgbm.LGBMClassifier(**other_params, probability=True, n_jobs=-1, force_col_wise=True, verbose=-1)
    ...
    parameters_score.to_excel('./opt_5.xlsx', index=False)

    print('Optimization finished')


if __name__ == '__main__':
    adj_params, fixed_params = lightgbm_parameters()
