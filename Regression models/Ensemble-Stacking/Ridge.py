...
i = 1
writer_y_fit = pd.ExcelWriter('y_fit_Ridge.xlsx')
writer_y_Test = pd.ExcelWriter('y_Test_Ridge.xlsx')
writer_y_fit_SC_1 = pd.ExcelWriter('y_fit_SC_1_Ridge.xlsx')
writer_y_SC_1 = pd.ExcelWriter('y_SC_1_Ridge.xlsx')
writer_y_fit_SC_2 = pd.ExcelWriter('y_fit_SC_2_Ridge.xlsx')
writer_y_SC_2 = pd.ExcelWriter('y_SC_2_Ridge.xlsx')
writer_y_fit_Drugbank = pd.ExcelWriter('y_fit_Drugbank_Ridge.xlsx')
writer_y_Drugbank = pd.ExcelWriter('y_Drugbank_Ridge.xlsx')
